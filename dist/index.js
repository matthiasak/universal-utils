...
module.exports = { cache: _cache2.default, store: _store2.default, resource: _resource2.default, router: _router2.default, batch: _fetch.batch, fetch: _fetch.fetch, cancellable: _fetch.cancellable, mux: _mux2.default, channel: _csp2.default, fp: fp, m: _vdom.m, html: _vdom.html, mount: _vdom.mount, update: _vdom.update, qs: _vdom.qs };